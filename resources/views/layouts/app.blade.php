        ...
        <div class="flex justify-between">
            <div class="flex items-center">
                ...
                <button data-dropdown class="flex items-center px-3 py-2 focus:outline-none hover:bg-gray-200 hover:rounded-md" type="button" x-data="{ open: false }" @click="open = true" :class="{ 'bg-gray-200 rounded-md': open }">
                    <img src="{{ asset('/storage/profile/blank_profile.png') }}" alt="Profle" class="h-8 w-8 rounded-full">
                    ...
                    <div data-dropdown-items class="text-sm text-left absolute top-0 right-0 mt-16 mr-4 bg-white rounded border border-gray-400 shadow" x-show="open" @click.away="open = false">
                        <ul>
                            <li class="px-4 py-3 border-b hover:bg-gray-200"><a href="{{ route('admin/profile') }}"><p class="text-black">My Profile</p></a></li>
                            <li class="px-4 py-3 border-b hover:bg-gray-200"><a href="#"><p class="text-black">Settings</p></a></li>
                            <li class="px-4 py-3 hover:bg-gray-200" style="text-decoration: none; color: black"><a href="{{ route('logout') }}"><p class="text-black">Log out</p></a></li>
                        </ul>
                    </div>
                </button>
